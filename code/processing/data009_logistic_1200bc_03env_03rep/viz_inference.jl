...
# Define file
files = Glob.glob("./output/advi_meanfield_R*10000*csv")
...
for file in files
    ...
    # Extract data
    data = df_counts[df_counts.rep.==rep, :]
    ...
    # Save figure 
    save("./output/figs/advi_vs_true_fitness_$rep.pdf", fig)
    ...
    save("./output/figs/advi_median_true_ecdf_$rep.pdf", fig)
