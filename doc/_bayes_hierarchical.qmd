...
@sec-bayes_mutfit. This expression can be simplified in two ways. First, the
...
The first term on the right-hand side of @eq-hier_bayes_exp_indep_02 takes the
same functional form as the one derived in @sec-bayes_mutfit. Therefore, all we
...
assumptions used for the fitness values in @sec-bayes_mutfit, we define the 
