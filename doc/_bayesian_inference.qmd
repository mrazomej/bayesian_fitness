...
However, modern algorithms such as Hamiltonian Monte Carlo (HMC) allow for the
efficient integration of arbitrary posterior distributions @betancourt2017. In
particular, this work is accompanied by the Julia library `BayesFitness.jl` that
makes use of the implementation of HMC samplers to numerically approximate the
solution of @eq-bayes_full_marginal within the Julia ecosystem @ge2018.