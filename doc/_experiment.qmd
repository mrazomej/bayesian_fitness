...
coli*. @fig-01(B) presents a typical barcode trajectory where the darker barcode
trajectories represent the so-called *neutral lineages* that are genetically
equivalent to the untagged ancestor strain that initially dominates the culture.
These neutral lineages simplify the inference problem since the fitness of all
relevant barcodes is quantified with respect to these barcodes.
...
neutral lineages.](./figs/fig01){#fig-01}
