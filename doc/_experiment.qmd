...
@fig-01(A)). Furthermore, a subfraction of labeled genotypes equivalent to
...
@fig-01(B) presents a typical barcode trajectory where the darker barcode
...
dotted line highlights the set of variables we are interested in. See
@sec-bayesian_inference for specific definitions of each
variable.](./figs/fig01){#fig-01}