...
modification allows us to map the structure of our original model to that of a
hierarchical model with a fitness hyperparameter vector $\underline{\theta}^G$,
where $G$ is the number of genotypes in the dataset.
