...
single measurement with higher coverage. 
<span style="color: #912E27;">
However, by doing so, we lose all information about experiment-to-experiment
variability due to intrinsic biological variability and environmental
fluctuations---such as small temperature fluctuations---that we cannot control.
In this sense, combining the datasets defeats the purpose of performing multiple
measurements to account for this variability when extracting the relevant
