...
file](`https://github.com/mrazomej/bayesian_fitness/code/processing/mcmc_logistic_data001/sim_data001.jl`)
...
- File location [link to
file](`https://github.com/mrazomej/bayesian_fitness/code/processing/data003_logistic_1000bc_03env_01rep/sim_multienv_data003.jl`)
...
- File location [link to
file](`https://github.com/mrazomej/bayesian_fitness/code/processing/data002_logistic_1000bc_01env_02rep/sim_hierarchical_data002.jl`)
...
- File location [link to
file](`https://github.com/mrazomej/bayesian_fitness/code/processing/data007_logistic_hierarchicalgenotype_1200bc_01env_01rep/sim_data007.jl`)
- Number of mutant barcodes
`n_mut = 900`
- Number of neutral barcodes
`n_neutral = 100`
