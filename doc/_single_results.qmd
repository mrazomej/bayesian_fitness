...
clear with @fig-02(E) where the empirical cumulative distribution function
(ECDF) of the absolute differences between the median inferred value and the
actual value shows that all median inferred values are within 0.3 units of
relative fitness from the ground truth.
